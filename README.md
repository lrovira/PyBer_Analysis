...
Based on the data, I think we should add more drivers in the suburban and rural cities because data demonstrates that the suburban and rural cities are reportedly higher than the urban. 
